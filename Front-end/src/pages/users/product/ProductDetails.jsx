...
const ProductDetails = () => {
  ...
  const getVariantForSize = (size) => {
    return variants.find(
      (variant) =>
        variant.size === size && variant.color === selectedColor
    );
  };
  ...
  const handleAddToCart = async () => {
    ...
    if (!selectedVariant) {
      alert("This color and size combination is not available.");
      return;
    }
  ...
  const submitReview = async (event) => {
    ...
    try {
      ...
      const newReview =
        response.data?.review || response.data?.data;
            ...
            <div className="mt-3">
              {selectedVariant ? (
                ...
                <p className="text-sm text-gray-500">
                  Select color and size to see availability.
                </p>
              )}
            </div>
            ...
            <div className="border-b border-gray-200">
              ...
              {openShipping && (
                <div className="pb-5 text-sm leading-6 text-gray-600">
                  ...
                  <p className="mt-2">
                    Items can be returned according to our return
                    policy.
                  </p>
                </div>
              )}
              ...
              <div className="space-y-8">
                {reviews.length === 0 ? (
                  <div className="border-b border-gray-200 pb-8">
                    <p className="text-sm text-gray-500">
                      No reviews yet. Be the first person to
                      review this product.
                    </p>
                  </div>
                ) : (
